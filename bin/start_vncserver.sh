...
client=$4
clientOS=$5
/usr/bin/vncserver :$displayport -name "$USER at `hostname -s`:$displayport $windowmanager" -autokill -depth 16 -xstartup /usr/projects/hpcsoft/common/openbox/3.6.1/etc/xdg/openbox/xstartup &>$LOG &
pid=$!
